...
class FINANCE{
        ...
        public function insert($data){
                // Account
                $account = (int) isset($data['account']) ? sanitize_int($data['account'],"finance->insert : account") :  return_fail('finance->insert : account is not defined in requested data');
                $account = R::load('account',$account);
                ...
                try{
                        ...
                        return_fail("finance->insert : exception ",$exp->getMessage());
                }
        }
